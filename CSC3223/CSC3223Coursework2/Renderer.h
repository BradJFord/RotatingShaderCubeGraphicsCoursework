...
namespace NCL {
	namespace CSC3223 {
		...
		public:
			void resetTime() //method below resets time whenever a new shader is called (to prevent having to restart the program every time I want to change the shader)
			{
				timeReset = frameTimer.GetTotalTime();
			}
